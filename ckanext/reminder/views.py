...
reminder.add_url_rule('/reminder/<subscriber_email>/unsubscribe/<unsubscribe_token>', view_func=unsubscribe_index,
                      methods=['GET'])
reminder.add_url_rule('/reminder/<subscriber_email>/unsubscribe/<unsubscribe_token>/all', view_func=unsubscribe_all,
                      methods=['POST'])
